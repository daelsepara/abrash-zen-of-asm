...
This change has no effect on overall functionality, because the net effect of `inc ax` in [Listing 13-26](#listing-13-26) is merely to subtract 3 from the offset of the end of the partial in-line code. I omitted this optimization in the interests of making [Listing 13-26](#listing-13-26) comprehensible, but as a general practice arithmetic should be performed at assembly time rather than at run time whenever possible.
